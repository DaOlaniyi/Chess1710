...
test suite for move_piece_not_pawn {
    example basic_piece_moves_legal is {some disj turnA, turnB:Turn | some p1,p2: Piece | wellformed_turn[turnA] and wellformed_turn[turnB] and wellformed_pieces and move_piece_not_pawn[turnA,p1] and move_piece_not_pawn[turnB,p2]} for {
         Turn = `turnA + `turnB
        `turnA.next = `turnB
        Piece = `p1 + `p2
        Pawn = `p
